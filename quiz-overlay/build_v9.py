...
def main() -> None:
    ...
    required = [
        ...
        HERE / "app_v9.py", HERE / "app_v8.py", HERE / "app_v7.py", HERE / "app_v6.py", HERE / "app_v5.py", HERE / "app_v4.py", HERE / "app_v31.py", HERE / "app_v3.py",
        ...
        HERE / "overlay_server_v9.py", HERE / "overlay_server_v8.py", HERE / "overlay_server_v7.py", HERE / "overlay_server_v6.py", HERE / "overlay_server_v5.py",
    ...
    args = [
        str(HERE / "app_v9.py"), "--noconfirm", "--clean", "--onefile", "--windowed", "--noupx",
        ...
        "--hidden-import=soop_client_v5", "--hidden-import=overlay_server_v9", "--hidden-import=overlay_server_v8", "--hidden-import=overlay_server_v7", "--hidden-import=overlay_server_v6", "--hidden-import=overlay_server_v5",
    ...
    exe = HERE / "dist-v9" / "SOOP-Quiz-Studio-v0.9.0.exe"
