...
def main() -> None:
    ...
    required = [
        ...
        HERE / "app_v8.py", HERE / "app_v7.py", HERE / "app_v6.py", HERE / "app_v5.py", HERE / "app_v4.py", HERE / "app_v31.py", HERE / "app_v3.py",
        HERE / "quiz_engine_v8.py", HERE / "quiz_engine_v7.py", HERE / "quiz_engine_v6.py", HERE / "quiz_engine_v5.py", HERE / "quiz_engine_v4.py", HERE / "quiz_engine_v3.py",
        HERE / "soop_client_v5.py", HERE / "soop_client_v4.py", HERE / "soop_client_v3.py",
        HERE / "overlay_server_v8.py", HERE / "overlay_server_v7.py", HERE / "overlay_server_v6.py", HERE / "overlay_server_v5.py",
    ...
    args = [
        str(HERE / "app_v8.py"), "--noconfirm", "--clean", "--onefile", "--windowed", "--noupx",
        "--name=SOOP-Quiz-Studio-v0.8.0",
        f"--distpath={HERE / 'dist-v8'}", f"--workpath={HERE / 'build-v8'}", f"--specpath={HERE}", f"--paths={HERE}",
        "--collect-all=customtkinter", "--hidden-import=websocket", "--hidden-import=customtkinter",
        "--hidden-import=quiz_engine_v8", "--hidden-import=quiz_engine_v7", "--hidden-import=quiz_engine_v6", "--hidden-import=quiz_engine_v5",
    ...
    exe = HERE / "dist-v8" / "SOOP-Quiz-Studio-v0.8.0.exe"
