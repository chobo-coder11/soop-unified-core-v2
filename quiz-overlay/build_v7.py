...
def main() -> None:
    ...
    required = [
        ...
        HERE / "app_v7.py", HERE / "app_v6.py", HERE / "app_v5.py", HERE / "app_v4.py", HERE / "app_v31.py", HERE / "app_v3.py",
        HERE / "quiz_engine_v7.py", HERE / "quiz_engine_v6.py", HERE / "quiz_engine_v5.py", HERE / "quiz_engine_v4.py", HERE / "quiz_engine_v3.py",
        HERE / "soop_client_v5.py", HERE / "soop_client_v4.py", HERE / "soop_client_v3.py",
        HERE / "overlay_server_v7.py", HERE / "overlay_server_v6.py", HERE / "overlay_server_v5.py", HERE / "core_runtime.py", HERE / "common.py",
    ]
    ...
    args = [
        str(HERE / "app_v7.py"), "--noconfirm", "--clean", "--onefile", "--windowed", "--noupx",
        "--name=SOOP-Quiz-Studio-v0.7.0",
        f"--distpath={HERE / 'dist-v7'}", f"--workpath={HERE / 'build-v7'}", f"--specpath={HERE}", f"--paths={HERE}",
        "--collect-all=customtkinter", "--hidden-import=websocket", "--hidden-import=customtkinter",
        "--hidden-import=quiz_engine_v7", "--hidden-import=quiz_engine_v6", "--hidden-import=quiz_engine_v5",
        "--hidden-import=soop_client_v5", "--hidden-import=overlay_server_v7", "--hidden-import=overlay_server_v6", "--hidden-import=overlay_server_v5",
    ...
    exe = HERE / "dist-v7" / "SOOP-Quiz-Studio-v0.7.0.exe"
