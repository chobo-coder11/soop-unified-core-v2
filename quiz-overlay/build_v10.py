...
def main() -> None:
    ...
    required = [
        ...
        HERE / "app_v10.py", HERE / "app_v9.py", HERE / "app_v8.py", HERE / "app_v7.py", HERE / "app_v6.py", HERE / "app_v5.py", HERE / "app_v4.py", HERE / "app_v31.py", HERE / "app_v3.py",
    ...
    args = [
        str(HERE / "app_v10.py"), "--noconfirm", "--clean", "--onefile", "--windowed", "--noupx",
        "--name=SOOP-Quiz-Studio-v0.10.0",
        f"--distpath={HERE / 'dist-v10'}", f"--workpath={HERE / 'build-v10'}", f"--specpath={HERE}", f"--paths={HERE}",
    ...
    exe = HERE / "dist-v10" / "SOOP-Quiz-Studio-v0.10.0.exe"
